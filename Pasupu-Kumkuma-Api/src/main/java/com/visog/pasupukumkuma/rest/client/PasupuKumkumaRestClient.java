package com.visog.pasupukumkuma.rest.client;
...
public class PasupuKumkumaRestClient {

	private static final Logger logger = Logger
			.getLogger(PasupuKumkumaRestClient.class);
	...
	public static String sendRequest(String urlStr, String contentType,
		...
		try {
			...
			throw new PasupuKumkumaException(e);
