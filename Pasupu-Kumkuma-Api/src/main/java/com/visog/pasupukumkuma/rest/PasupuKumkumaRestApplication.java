...
import com.visog.pasupukumkuma.rest.controller.transactional.CartOrdersController;
...
import com.visog.pasupukumkuma.rest.controller.transactional.RefferalDetailsController;
...
public class PasupuKumkumaRestApplication extends Application {
	...
	public PasupuKumkumaRestApplication() {
		...
		classes.add(RefferalDetailsController.class);
