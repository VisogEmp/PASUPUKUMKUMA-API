...
public class ContextListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		logger.info(" End: Calling Pasupu Kumkuma ContextListener.contextInitialized() method");
	}
	...
	public void contextDestroyed(ServletContextEvent sce) {
		...
		logger.info(" Start: Calling Pasupu Kumkuma ContextListener.contextDestroyed() method");
		
		logger.info(" End: Calling PasupuKumkuma ContextListener.contextDestroyed() method");
	}
