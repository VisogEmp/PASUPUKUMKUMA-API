package com.visog.pasupukumkuma.servlet;
...
import com.visog.pasupukumkuma.exceptions.PasupuKumkumaException;
import com.visog.pasupukumkuma.res.PasupuKumkumaResponse;
import com.visog.pasupukumkuma.utils.PropertyUtil;
...
public class RestInterceptor implements ContainerRequestFilter, ContainerResponseFilter, ExceptionMapper<Throwable> {
	...
	public Response toResponse(Throwable t) {
		PasupuKumkumaResponse response = new PasupuKumkumaResponse();
		
		PasupuKumkumaException u = null;
		if(t.getCause() instanceof PasupuKumkumaException) {
			logger.error("Cause is PasupuKumkumaException>>>>>>>>>>>>");
			u = (PasupuKumkumaException) t.getCause();
		} else if (t instanceof PasupuKumkumaException) {
			logger.error("Exception is PasupuKumkumaException>>>>>>>>>>>>");
			u = (PasupuKumkumaException) t;
		} else {
