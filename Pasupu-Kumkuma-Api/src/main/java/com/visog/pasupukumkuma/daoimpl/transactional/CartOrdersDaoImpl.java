...
@Singleton
@Transactional
public class CartOrdersDaoImpl extends AbstractDao implements CartOrdersDao{
	
	private static final Logger logger = Logger.getLogger(CartOrdersDaoImpl.class);
