CREATE TABLE users (
  ...
  NAKSHYATRAM_ID varchar(37) NOT NULL,
  ...
  FOREIGN KEY (NAKSHYATRAM_ID) REFERENCES NAKSHYATRAM(ID),
...
CREATE TABLE puja_orders_details (
  ...
  puja_samagri_id varchar(150) NOT NULL,
  CREATED_SID   VARCHAR(37) NOT NULL,
	...
	UPDATED_ON    TIMESTAMP,
   PRIMARY KEY (id),
   FOREIGN KEY (puja_order_id) REFERENCES PUJAS(ID),   
...
CREATE TABLE puja_orders_details (
  ...
  CREATED_BY    VARCHAR(37) NOT NULL,
	...
	UPDATED_ON    TIMESTAMP,
   PRIMARY KEY (id),
   FOREIGN KEY (cart_order_id) REFERENCES cart_orders(ID),   
   FOREIGN KEY (puja_samagri_id) REFERENCES puja_samagri(ID)
)
...
CREATE TABLE COUPAN_VALUE(  ---REFERRED BY ,REFERRED TO
	ID VARCHAR(37) NOT NULL,
	COUPAN_TYPE_ID  VARCHAR(37)UNIQUE NOT NULL,
	AMOUNT  DOUBLE,	
	CREATED_BY    VARCHAR(37) NOT NULL,
	CREATED_ON    TIMESTAMP NOT NULL,
	UPDATED_BY    VARCHAR(37),
	UPDATED_ON    TIMESTAMP,
	PRIMARY KEY (ID) ,
	FOREIGN KEY (COUPAN_TYPE_ID) REFERENCES COUPAN_TYPE(ID)	
	);
...
CREATE TABLE COUPAN_DETAILS (
  id VARCHAR(37) NOT NULL,
  COUPAN_TYPE_ID  VARCHAR(37) NOT NULL,
